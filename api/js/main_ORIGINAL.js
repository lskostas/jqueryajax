...
var rootURL = "http://localhost/jqueryajax/api/articles";
...
function renderDetails(wine) {
	...
	$('#cat_id').val(wine.category_description); // val(wine.category_description); einai to onoma pediou pou kano join wine kai category_wine
